...
# This is a Heroku-specific Docker file
# You will probably want to build this with:
...
RUN echo 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX'
RUN echo $PORT
RUN echo 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX'
RUN echo $PORT > /var/local/port.txt

# WARNING! Heroku forces us to use the port it wants in $PORT

# This is an experiment --- I'm trying to remove this to prevent
# the error caused binding to port 80 under heroku.
